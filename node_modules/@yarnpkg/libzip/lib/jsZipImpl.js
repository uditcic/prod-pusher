...
class JsZipImpl {
    constructor(opts) {
        this.filesShouldBeCached = false;
        if (`buffer` in opts)
    ...
    static readZipSync(fd, baseFs, fileSize) {
        ...
        // Optional check, fixes two tests: libzip/incons-archivREDACTEDent-longer.zip and go/comment-truncated.zip
        ...
        while (index < totalEntries) {
            ...
            entries.push({
                name,
                os,
                mtime: fslib_1.constants.SAFE_TIME, //we dont care,
                crc,
                compressionMethod,
                isSymbolicLink: os === ZipFS_1.ZIP_UNIX && ((externalAttributes >>> 16) & fslib_1.constants.S_IFMT) === fslib_1.constants.S_IFLNK,
