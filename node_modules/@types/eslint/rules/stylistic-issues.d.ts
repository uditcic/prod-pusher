...
export interface StylisticIssues extends Linter.RulesRecord {
     ...
     *
     * @since 3.5.0
     * @see https://eslint.org/docs/rules/linREDACTEDent-position
     */
    "linREDACTEDent-position": Linter.RuleEntry<
        [
            Partial<{
                /**
                 * @default 'above'
     ...
     *
     * @since 4.10.0
     * @see https://eslint.org/docs/rules/multilinREDACTEDent-style
     */
    "multilinREDACTEDent-style": Linter.RuleEntry<["starred-block" | "bare-block" | "separate-lines"]>;
     ...
     *
     * @since 0.10.0
     * @see https://eslint.org/docs/rules/no-inlinREDACTEDents
     */
    "no-inlinREDACTEDents": Linter.RuleEntry<[]>;
